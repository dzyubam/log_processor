...
processor_db_session = scoped_session(
    sessionmaker(autocommit=False, autoflush=False, bind=processor_engine)
)
report_db_session = scoped_session(
    sessionmaker(autocommit=False, autoflush=False, bind=report_engine)
)
